...
formInsert.addEventListener("submit", (e) => {
  ...
  const reglaTarea = (regex2.test(tarea) || regex3.test(tarea)) || !regex1.test(tarea)

  const mensajeRegex = "Caracteres no válidos"
  if (reglaUsuario && reglaTarea ) {
    ...
    document.getElementById("errorTarea").textContent = mensajeRegex;
    return
  }
